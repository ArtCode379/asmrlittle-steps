...
import asmrtraders.babycare.asmrlittlesteps.di.dataModule
import asmrtraders.babycare.asmrlittlesteps.di.dispatcherModule
import asmrtraders.babycare.asmrlittlesteps.di.viewModule
...
class GCZCTApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@GCZCTApplication)
            modules(appModules)
        }
